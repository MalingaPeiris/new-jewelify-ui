                  ...
                  <div className="col-md-7 col-sm-7">
                    <div className="top-text pt-20">
                      <div className="slider-text">
                        ...
                        <p>
                          Jewelify is an easy to use platform that enables you
                          to sync your in store POS system with any platform to
                          instantly start selling online.
                        </p>
              ...
              <div className="row boxes-row">
                ...
                <div className="col-md-6 box-container">
                  ...
                  <span className="bold-line">
                    Experience more enhanced analytics
                  </span>
                </div>
                <div className="col-md-6 box-container">
                  <div className="box">
                  ...
                  <span className="bold-line">
                    Effciently manage inventory and payment transactions
                  </span>
                </div>
              </div>
              <div className="row">
                <div className="col-12 text-center">
                  <Link href="/pricing">
                    <a className="banner-button">GET STARTED NOW</a>
                  </Link>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-12">
                  <div className="title-cont">
                    ...
                    <p>
                      Software exclusively designed for jewelry store owners.{" "}
                      <br />
                      Here’s how we aim to take your offline jewelry business to
                      the next level of success like never before:
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="row flex-property">
                ...
                <div className="col-md-6 col-sm-12">
                  <div className=" clearfix text-style">
                    <h2>
                      Simplify Inventory <br /> Management
                    </h2>
                    <p className="about-pb">
                      Take in-store inventory online and get rid of manual data
                      input. Perform time-consuming tasks in just a few clicks:
                    </p>
                    <ul>
                      <li>Update stock</li>
              ...
              <div className="row flex-property">
                <div className="col-md-6 col-sm-12">
                  <div className=" clearfix text-style">
                    ...
                    <p className="about-pb">
                      As offline and online systems are synced, you can download
                      web orders into your POS right away. It helps you
                      streamline orders so you can:
                    </p>
                    <ul>
                      <li>Avoid overselling</li>
                      <li>
                        Lower the risk of cutting customer orders due to stock
                        shortage
                      </li>
            ...
            <div className="container">
              <div className="row flex-property">
                ...
                <div className="col-md-6 col-sm-12">
                  <div className="clearfix text-style">
                    <h2>
                      Offer Cross-Channel <br /> Promotions
                    </h2>
                    <p className="about-pb">
                      Expand your customer base and boost sales strategically
                      through cross-channel promotions. With Jewelify seamless
                      POS and ecommerce integration, give your customers the
                      power and freedom to redeem:
                    </p>
                    <ul>
                      <li>Coupons</li>
                      <li>Gift cards</li>
                    ...
                    <br />
                    <p>
                      Additionally, cross-channel promotions and incentives
                      help: <br />
                      Increase revenues
                    </p>
                    <ul>
                      ...
                      <li>
                        Lower fraud risk (common in manually entered discounts)
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-md-6 col-sm-12">
                  <div className=" clearfix text-style pt-80">
                    <h2>
                      Know Your Customer <br /> Better
                    </h2>
                    <p className="about-pb">
                      By integrating your legacy POS system with Jewelify, you
                      can get clear insights about your customers and their
                      purchase behavior. This can:
                    </p>
                    <ul>
      ...
      ============================================ */}
          <div id="testimonial-area" className="all-about">
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-2 col-sm-12 col-xs-12 pad b-m-res"></div>
                <div className="col-md-4 col-sm-12 col-xs-12 pad b-m-res">
                  <div className="text-center txt">
                    <a href="#">
                      <img src="/img/Ellipse 1.png" alt="" className="mb-20" />
                    </a>
                    <h3>Esther Howard</h3>
                    <p className="color font-weight">marketing SA company</p>
                    <p>
                      The integration of our legacy POS with our online partners
                      through Jewelify has helped us reach out to more customers
                      and boost sales in the fastest time. We highly recommend
                      to it all jewelry owners who haven’t gone online yet.
                    </p>
                  </div>
                </div>
                <div className="col-md-4 col-sm-12 col-xs-12 pad b-m-res">
                  <div className="text-center txt">
                    ...
                    <p className="color font-weight">marketing SA company</p>
                    <p>
                      Jewelify has simplified selling jewelry for us as we can
                      manage online orders, inventory, and update stock promptly
                      without any delay. We are fully aware of our inventory
                      levels and manage them strategically so that all orders
              ...
              <div className="how-inner">
                <div className="row">
                  <div className="col-lg-8 col-md-6 left-part">
                    ...
                    <p>
                      Allow us to take you on a quick and no-pressure tour of
                      our platform, Jewelify. We’ll show you how our platform
                      synchronizes your offline and online business for
                      success.Synchronize Online Sales, Shoppers, and Inventory
                      through Jewelify.
                    </p>
                    <div className="button-set">
              ...
              <div className="row">
                <div className="col-12">
                  <div className="title-cont">
                    ...
                    <p>
                      We have a plan for every budget. Scale and upgrade your
                      plan as you grow. Explore our different pricing plans to

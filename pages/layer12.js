            ...
            <div className="row">
              <div className="col-md-12 text-center">
                <div className="about-bottom-left mb-30 clearfix text-style">
                  <h2>Format Your Inventory To Start Selling Through WooCommerce</h2>
                  <p style={{ fontSize: '19px' }}>Use the dropdown menu for WooCommerce to let us know what each field is equal to</p>
                </div>
                <div className="row pb-100">
                  <div className="col-12 text-center">
                    <form action className="int-form">
                      <div className="form-group">
                        <label style={{ fontWeight: 400 }} htmlFor>JCS</label>
                        <div className="input-group">
                          <input type="text" placeholder="Inventory_Data" />
                        </div>
                      </div>
                      <div className="form-group">
                        <label style={{ fontWeight: 400 }} htmlFor>WooCommerce</label>
                        <div className="input-group">
                          <input type="select" placeholder="Choose data" />
                        </div>
                      </div>
                      <br />
                      ...
                      <div className="alert">
                        <img src="/img/alert.png" alt="" width="15px" />
                        There wil be additional mapping for the next step.
                      </div>
                    </form>
                  </div>
                </div>
